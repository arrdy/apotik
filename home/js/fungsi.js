	...
	function tampil(view,hal,field,value){  // UNTUK CONTENT
	    ...
	    if(view.substr(0,5)=='tabel') { document.getElementById('cari').hidden=false; }else{ document.getElementById('cari').hidden=true; }
	}
    ...
    else if(document.getElementById('t_debit').value=='0' || document.getElementById('t_kredit').value=='0')
