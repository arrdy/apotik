...
<div style='margin-left:150;'>  
	<strong> <font size='5'> BUKTI TRANSAKSI  </font>  </strong>
</div> 
<hr>
<br><br>
<table border=0 width=100% align=left style='border:0px; margin-left:10;'>";					
									require_once "../koneksi.php"; 
									$cariagt = mysqli_query($con,"select dp.nota,k.nama,p.tgl,o.nama_obat,s.satuan,g.kategori from det_penjualan dp
																	left join penjualan p on p.nota=dp.nota
...
") or die('gagal pencarian data !'); 
											...
											<tr  bgcolor='beige' class='satu' >
												<td align=left width=40%>Nota </td>
												<td > : ".$u['nota']."</td>
											</tr>
											<tr  bgcolor='beige' class='satu' >
...
<table border='0' width=100% align=left style='border:0px; margin-left:10;'>";
				...
				$n=0;
				 ...
				 $content .= "
					...
					if(!empty($_GET['id']))
					{	$edit_id = $_GET['id'];
					$cariju = mysqli_query($con,"select dp.*,k.nama,p.tgl,o.nama_obat,s.satuan,g.kategori from det_penjualan dp
left join penjualan p on p.nota=dp.nota
left join  karyawan k on k.id_karyawan=p.id_karyawan
left join obat o on o.kd_obat=dp.kd_obat 
left join satuan s on s.id_satuan=o.id_satuan
left join kategori g on g.id_kategori=o.id_kategori
									...
									where p.nota='$id' ") or die('gagal pencarian data !'); 
